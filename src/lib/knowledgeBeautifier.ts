...
function getConsecutiveNumberedItems(text: string) {
  ...
  // Requiring substantive text on each side avoids treating decimal values,
  // dates, or isolated numeric references as a list.
...
/**
 * Improve presentation of unstructured, consecutive numbered prose without
 * writing back to the source document. Only plain-text block nodes and clearly
 * consecutive markers are converted; existing HTML lists remain untouched.
 */
