...
export function nativeRoute(raw: string, currentUid?: string | null): string | null {
  try {
    ...
    return ["today","tomorrow","next7","inbox","notes","checkin","garden","pomodoro","settings","mind","thoughts","abc","socratic","breathing","worry","life-architect","widgets"].includes(route) ? "/app/" + route : null;
  } catch { return null; }
}
